<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs" Inherits="AutoCareApp.AdminRegister" %>
                ...
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card">
                        ...
                        <div class="footer text-center mb-3">
                            <asp:Button ID="btnCreateUser" runat="server" OnClick="CreateUser_Click" Text="Add Admin" CssClass="btn btn-default" OnClientClick="return validateForm();" />
                        </div>
