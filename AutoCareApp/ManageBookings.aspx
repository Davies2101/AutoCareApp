<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageBookings.aspx.cs" Inherits="AutoCareApp.ManageBookings" %>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                    <asp:Button ID="btnStart" runat="server" Text="Start" CssClass="dropdown-item" BookingId='<%# Eval("BookingNo")%>' OnClick="btnStart_OnClick" />
                                                                    <asp:Button ID="btnEnd" runat="server" Text="End" CssClass="dropdown-item" BookingId='<%# Eval("BookingNo")%>' OnClick="btnEnd_OnClick"/>
