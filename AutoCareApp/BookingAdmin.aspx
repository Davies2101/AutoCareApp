<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="BookingAdmin.aspx.cs" Inherits="AutoCareApp.BookingAdmin" %>
                ...
                <div class="card col-xl-12 mt-2">
                    <asp:Wizard runat="server" DisplaySideBar="False" ID="Wizard1" OnPreRender="Wizard1_OnPreRender" OnActiveStepChanged="Wizard1_OnActiveStepChanged">
                        ...
                        <FinishNavigationTemplate>
                            ...
                            <asp:Button ID="FinishButton" runat="server" Text="Update Now" CommandName="MoveComplete" CssClass="btn btn-default" OnClick="FinishButton_OnClick" />
                        </FinishNavigationTemplate>
                    </asp:Wizard>
                </div>
            </div>
                ...
                <div class="modal-content bg-gradient-success">
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <h4 class="heading mt-4">Booking has been updated sucessfully!</h4>
    ...
    <script type="text/javascript">
        ...
        function redirectToHome() {
            ...
            setInterval(function () {
                ...
                lblCount.innerHTML = seconds;
                if (seconds == 0) {
                    window.location = "ManageBookings.aspx";
                }
            }, 1000);
        }
    </script>
